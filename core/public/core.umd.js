(function(factory) {
    ...
    try {
      if (vnode.shapeFlag & 4) {
        ...
        if ({ "NODE_ENV": "production" }.NODE_ENV !== "production" && attrs === props)
          ;
        result = normalizeVNode(render3.length > 1 ? render3(props, { "NODE_ENV": "production" }.NODE_ENV !== "production" ? {
          get attrs() {
            markAttrsAccessed();
            return attrs;
          },
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_custom_field = resolveComponent("custom-field");
    const _component_custom_field2 = resolveComponent("custom-field2");
    return openBlock(), createElementBlock("div", null, [
      createTextVNode(" Hello "),
      createBaseVNode("div", null, [
        createTextVNode(" field 1 "),
        createVNode(_component_custom_field)
      ]),
      createBaseVNode("div", null, [
        createTextVNode(" field 2 "),
        createVNode(_component_custom_field2)
      ])
    ]);
  }
  ...
  class Ant {
    ...
    boot() {
      ...
      this.vue.component("custom-field", defineAsyncComponent(() => Promise.resolve().then(() => Field$1)));
